         ...
         <div class="w-full lg:w-1/2 xl:w-6/12 px-4">
            <div class="max-w-[570px] mb-12 lg:mb-0 rounded-xl border-4 border-[#84754E] bg-white">
               ...
               <div class="flex mb-8 max-w-[370px] w-full justify-center">
                  ...
                  <div class="w-full">
                     <h4 class="font-bold text-dark text-xl mb-1 text-ryles-blue">Our Location</h4>
                     <p class="text-base text-body-color text-ryles-blue">
                        35 Ashe Street, Tralee, Ireland V92 XT20
                     </p>
                  </div>
               </div>
               <div class="flex mb-8 max-w-[370px] w-full">
                  ...
                  <div class="w-full">
                     <h4 class="font-bold text-dark text-xl mb-1 text-ryles-blue">Phone Number</h4>
                     <p class="text-base text-body-color text-ryles-blue">(066) 71 24701</p>
                  </div>
               </div>
               <div class="flex mb-8 max-w-[370px] w-full">
                  <div
                  ...
                  <div class="w-full">
                     <h4 class="font-bold text-dark text-xl mb-1 text-ryles-blue">
                        Email Address
                     </h4>
                     <p class="text-base text-body-color text-ryles-blue">RylesPharmacy@gmail.com</p>
                  </div>
               </div>
            </div>
         </div>
